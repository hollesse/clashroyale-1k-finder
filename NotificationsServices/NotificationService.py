class NotificationService(object):
    ...
    def send_notification(self, title: str, message: str) -> None:
        """
        Sends a notification to inform about newly found 1k tournaments to the device with the device_identifier
        created in the constructor. Some notification services also need an api key.
    ...
    def send_test_notification(self) -> None:
        """
        Sends a test notification to the device with the device_identifier created in the constructor.
